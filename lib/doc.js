...

{
	...
	class DocQuote extends HTMLElement {
		...
		#importStyles(srcDoc) {
			...
			const cssParentElm = srcDoc.querySelector("template")?.content || srcDoc;
			const qryCssElms = "style, link[rel=\"stylesheet\"]";
			const srcCssElms = cssParentElm.querySelectorAll(qryCssElms);
